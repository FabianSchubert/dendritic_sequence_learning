...
fig_act_pd_end, ax_act_pd_end = plt.subplots(1,1,figsize=figdim)
...
ax_act_pd_end.plot(I_p_rec[-t_wind:],I_d_rec[-t_wind:],'.',c=(1.,0.4,0.),alpha=0.5,rasterized=True)
ax_act_pd_end.set_xlabel("$I_{p}$")
ax_act_pd_end.set_ylabel("$I_{d}$")

ax_act_pd_end.set_title("Last " + str(int(100.*t_wind/n_t_learn))+"% of learning phase")

plt.tight_layout()

fig_act_pd_end.savefig(PLOTSFOLD_SINGLE_NEURON + "act_pd_end." + DAT_FORMAT)
